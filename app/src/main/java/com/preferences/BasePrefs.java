...
public abstract class BasePrefs {
    ...
    public boolean setStringSetKeyValuePrefs (String key, HashSet<String> value) {
        if (!isValidTransaction()) return false;
        SharedPreferences prefs = getContext().getSharedPreferences(getPrefsName(),
                Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = prefs.edit();
    ...
    public HashSet<String> getStringSetKeyValuePrefs (String key) {
        if (!isValidTransaction()) return new HashSet<>();
        SharedPreferences prefs = getContext().getSharedPreferences(getPrefsName(),
                Context.MODE_PRIVATE);
