...
public class DiffCallBackMatchedBetModel extends DiffUtil.Callback {
    private final List<BetDataModel.BetUserData> mOldList;
    private final List<BetDataModel.BetUserData> mNewList;

    public DiffCallBackMatchedBetModel(List<BetDataModel.BetUserData> mOldList, List<BetDataModel.BetUserData> mNewList) {
