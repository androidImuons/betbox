 ...
 */
public class ConfirmBetDialog extends Dialog implements
        View.OnClickListener {
    Context context;
    ConfirmBetDialog dia;
    ...
    public ConfirmBetDialog(Context context) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View layout = inflate.inflate(R.layout.dialog_confirm_bet, null);
