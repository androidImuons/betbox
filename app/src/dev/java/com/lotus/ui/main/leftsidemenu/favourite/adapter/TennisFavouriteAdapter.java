...
public class TennisFavouriteAdapter extends BaseRecycleAdapter {

    private Context context;
    private List<MatchDetailModel> list = new ArrayList<>();

    public TennisFavouriteAdapter(Context context) {
    ...
    public BaseViewHolder getViewHolder() {
        return new ViewHolder(inflateLayout(R.layout.item_favourite_tennis));
    }
...
//    }
    ...
    private class ViewHolder extends BaseViewHolder {
        ...
        private TennisFavouriteChildAdapter adapter;
        ...
        public void setData(int position) {
            ...
            adapter = new TennisFavouriteChildAdapter(getContext(), matchMarketModel) {
                @Override
                public List<BetSlipModel> getPlacedBets(String marketId) {
                    return TennisFavouriteAdapter.this.getPlacedBets(marketId);
                }
            };
