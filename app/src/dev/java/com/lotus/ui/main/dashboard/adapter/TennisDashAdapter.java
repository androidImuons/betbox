...
public class TennisDashAdapter extends BaseRecycleAdapter {

    private Context context;
    private List<MatchDetailModel> list = new ArrayList<>();

    public TennisDashAdapter(Context context) {
        this.context = context;
    }

    @Override
    public BaseViewHolder getViewHolder() {
        return new ViewHolder(inflateLayout(R.layout.item_dash_board_tennis));
    }
    ...
    private class ViewHolder extends BaseViewHolder {
        ...
        private TennisChildAdapter adapter;
        ...
        public void setData(int position) {
            ...
            adapter = new TennisChildAdapter(getContext(), matchMarketModel) {
                @Override
                public List<BetSlipModel> getPlacedBets(String marketId) {
                    return TennisDashAdapter.this.getPlacedBets(marketId);
                }
            };
