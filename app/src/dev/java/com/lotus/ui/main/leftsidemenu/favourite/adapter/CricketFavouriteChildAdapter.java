...
public class CricketFavouriteChildAdapter extends BaseRecycleAdapter {

    private Context context;
    private List<RunnersModel> list = new ArrayList<>();
    MatchMarketModel matchMarketModel;

    public CricketFavouriteChildAdapter(Context context, MatchMarketModel matchMarketModel) {
    ...
    public BaseViewHolder getViewHolder() {
        return new ViewHolder(inflateLayout(R.layout.item_dashboard_cricket_child));
    }
