...
public class MarketChildAdapter extends BaseRecycleAdapter {

    private Context context;
    private List<RunnersModel> list = new ArrayList<>();
    MatchMarketModel matchMarketModel;

    public MarketChildAdapter(Context context, MatchMarketModel matchMarketModel) {
    ...
    public BaseViewHolder getViewHolder() {
        return new ViewHolder(inflateLayout(R.layout.item_market_child));
    }
