...
public class MatchBetAdapter extends BaseRecycleAdapter {

    private Context context;
    private List<BetDataModel.BetUserData> list = new ArrayList<>();

    public MatchBetAdapter(Context context) {
    ...
    public void updateData(List<BetDataModel.BetUserData> list, DiffUtil.DiffResult matchedDiffResult) {
        this.list.clear();
        if (list != null)
            this.list.addAll(list);
        matchedDiffResult.dispatchUpdatesTo(this);
    }
    ...
    private class ViewHolder extends BaseViewHolder {
        ...
        public void setData(int position) {
            ...
            Log.e("121212", "setData: Matched " + position);
