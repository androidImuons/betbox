...
public class SoccerFavouriteChildAdapter extends BaseRecycleAdapter {

    private Context context;
    private List<RunnersModel> list = new ArrayList<>();
    MatchMarketModel matchMarketModel;

    public SoccerFavouriteChildAdapter(Context context, MatchMarketModel matchMarketModel) {
    ...
    public BaseViewHolder getViewHolder() {
        return new ViewHolder(inflateLayout(R.layout.item_dashboard_soccer_child));
    }
