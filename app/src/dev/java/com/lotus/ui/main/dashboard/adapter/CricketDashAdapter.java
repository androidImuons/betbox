...
public class CricketDashAdapter extends BaseRecycleAdapter {

    private Context context;
    private List<MatchDetailModel> list = new ArrayList<>();


    public CricketDashAdapter(Context context) {
        this.context = context;
    }

    @Override
    public BaseViewHolder getViewHolder() {
        return new ViewHolder(inflateLayout(R.layout.item_dash_board_cricket));
    }
    ...
    private class ViewHolder extends BaseViewHolder {
        ...
        private CricketChildAdapter adapter;
        ...
        public void setData(int position) {
            ...
            adapter = new CricketChildAdapter(getContext(), matchMarketModel) {
                @Override
                public List<BetSlipModel> getPlacedBets(String marketId) {
                    return CricketDashAdapter.this.getPlacedBets(marketId);
                }
            };
