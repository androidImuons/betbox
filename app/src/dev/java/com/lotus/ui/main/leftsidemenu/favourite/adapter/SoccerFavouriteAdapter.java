...
public class SoccerFavouriteAdapter extends BaseRecycleAdapter {

    private Context context;
    private List<MatchDetailModel> list = new ArrayList<>();

    public SoccerFavouriteAdapter(Context context) {
        this.context = context;
    }

    @Override
    public BaseViewHolder getViewHolder() {
        return new ViewHolder(inflateLayout(R.layout.item_favourite_soccer));
    }
...
//    }
    ...
    private class ViewHolder extends BaseViewHolder {
        ...
        private SoccerFavouriteChildAdapter adapter;
        ...
        public void setData(int position) {
            ...
            adapter = new SoccerFavouriteChildAdapter(getContext(), matchMarketModel) {
                @Override
                public List<BetSlipModel> getPlacedBets(String marketId) {
                    return SoccerFavouriteAdapter.this.getPlacedBets(marketId);
                }
            };
